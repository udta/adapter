...
module.exports = function(edgeVersion) {
  ...
  RTCPeerConnection.prototype._createIceAndDtlsTransports = function(mid,
    ...
    iceTransport.onicestatechange = function(event) {
      ...
      console.error("ICE transport event is: "+event.state);
      ...
      sections.forEach(function(mediaSection, sdpMLineIndex) {
        ...
        if (!rejected && !transceiver.isDatachannel) {
          ...
          var remoteDtlsParameters = SDPUtils.getDtlsParameters(
              mediaSection, sessionpart);
          //Modfied by rzhang, force as server
  ...
  RTCPeerConnection.prototype.setRemoteDescription = function(description) {
    ...
    sections.forEach(function(mediaSection, sdpMLineIndex) {
      ...
      if (!rejected) {
        ...
        remoteDtlsParameters.role = 'server'; //Modified by rzhang. Force remote as server. 
      }
      ...
      //Modified by rzhang, force as completed
      isComplete = true;
  ...
  RTCPeerConnection.prototype._updateConnectionState = function() {
    ...
    this.transceivers.forEach(function(transceiver) {
      ...
      console.error("PeerConnction " + transceiver.kind + " - " +transceiver.mid + " ICE Transport stat is: "+transceiver.iceTransport.state);
      console.error("PeerConnction " + transceiver.kind + " - " +transceiver.mid + " DTLS Transport stat is: "+transceiver.dtlsTransport.state);
    ...
    console.error("PeerConnction stat is: "+newState);
